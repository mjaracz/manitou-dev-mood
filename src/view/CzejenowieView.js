...
import Image from '../assets/img2mini.JPG';
...
class CzejenowieView extends Component {
  render() {
    return (
      <main>
        ...
        <FloatingActionButton 
          secondary={true} backgroundColor="#ff6600b2"
          disabledColor="#ff6600b2" style={{backgroundColor: "#ff6600b2", marginTop: 25,}}
          iconStyle={{backgroundColor: "#ff6600b2"}}
        >
          <ContentAdd />
        </FloatingActionButton>
      </main>
